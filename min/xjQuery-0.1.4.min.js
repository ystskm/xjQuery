...
f(c,"error")}});for(var i=0;i<a.length;i++)setTimeout(a[i],0)}},assign:function(a,c){var b=this;switch(typeof a){case "string":return function(){b.load(a,function(b){f(a+" is Loaded."+(!0===b?"(timeout message)":""));c.resolve()},function(){f("fail to load script : "+a,"error");c.resolve()})};case "function":return function(b){try{a.call(),b.resolve()}catch(c){b.reject()}}}},load:function(a,c,b){function d(b){var c=location.protocol,d=location.host,h=location.port||(/^http:/.test(c)?80:443),l=/(^https?:)/.test(a)?
RegExp.$1:c,m=/\/\/([^\/]+)\//.test(a)?RegExp.$1:d,n=/:(\d+)$/.test(m)?RegExp.$1:/^http:/.test(l)?80:443;k.evalMode&&c==l&&d==m&&h==n?b?i(b):g.ajax({type:"get",url:a,dataType:"text",success:e}):(k.evalMode&&f("xjQuery Notice: "+a+" is read by tag."),j())}function e(a){i(a)}function i(b){var e=!1;l[a]=n;localStorage.setItem([n,".",a].join(""),b);try{g.globalEval(b)}catch(d){e=!0,f("Error from JSLoader : misssing eval. src = "+a)}e?j():(c||g.noop)()}function j(){var e=k.append||document.body||document.documentElement,
d=document.createElement("script");d.src=a;d.type=k.type?k.type:"text/javascript";d.onload=function(){!0===m&&e.removeChild(d);c.apply(this,arguments)};d.onerror=function(){!0===m&&e.removeChild(d);b.apply(this,arguments)};if(k.charset)d.charset=k.charset;if(document.all)d.onreadystatechange=function(){switch(d.readyState){case "complete":case "loaded":d.onload();break;case "error":d.onerror()}};e.appendChild(d)}var h;h=null;var k=this.options,l=k.srcManager,m=k.removeOnLoad,o=k.packageName,n=k.versionString;
if(/\.-([\w\.-]+)-pkg/.test(a))o=RegExp.$1,a=a.replace(/\.-([\w\.-]+)-pkg/,""),n=n.replace(/^\w+-/,[o,"-"].join(""));/\.-([\w\.-]+)-ver/.test(a)?(n=RegExp.$1,a=a.replace(/\.-([\w\.-]+)-ver/,""),n=n.replace(/-\w+$/,["-",n].join(""))):/\.no-version/.test(a)&&(a=a.replace(/\.no-version/,""),h=!0);if(!h&&n)if(h=[n,".",a].join(""),h=localStorage.getItem(h))f(a+" is found on localStorage!"),d(h);else{if(h=l[a])localStorage.removeItem([h,".",a].join("")),f(a+" is deleted from localStorage.");d()}else d()}}));
o.add("LAYOUT",{layCenter:function(a,c){function b(a,b){var c;try{c=a.css(b)}catch(d){}return!c||isNaN(aft=c.replace("px"))?a[b]():parseInt(aft)}var d=(b(a,"width")-b(c,"width"))/2,e=(b(a,"height")-b(c,"height"))/2;return{left:0<d?d:0,top:0<e?e:0}}});n.$xj.add("JSCSS",{crossCssAuto:function(a){"boolean"==typeof a&&(j=a);return j},crossCss:t,codeAdjust:s,codeToRgb:function(a){a=s(a).replace(/^#/,"");return[parseInt(a.slice(0,2),"16"),parseInt(a.slice(2,4),"16"),parseInt(a.slice(4,6),"16")]}});var j=
!0,k=o.uaAnalyze(n.navigator.userAgent);g.extend(l.JSCSS,k);g.extend(o,k);var v=g.fn.css;g.fn.css=function(){if(!1===j||"string"==typeof arguments[0]&&1==arguments.length)return v.apply(this,arguments);var a={};"string"==typeof arguments[0]?a[arguments[0]]=arguments[1]:a=arguments[0];return v.call(this,t(a))};if("undefined"==typeof WebSocket&&"undefined"!=typeof MozWebSocket)n.WebSocket=MozWebSocket})(window,window.$);
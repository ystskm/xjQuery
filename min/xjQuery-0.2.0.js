  ...
  $xj.add('require', xjQuery.CLASS.makeClass({
    ...
    initialize: function(files, options, callback) {
      ...
      this.finish = function(err, chainLast) {
        $.isFunction(self.options.finish) ? 
          self.options.finish(err, chainLast): chainLast();
      };
